      ...
      <li class="popular-goods-item swiper-slide">
        ...
        <button type="button"
         class="category-btn${r===""?" active":""}"
          ...
          `}).join("");a.categoriesList.insertAdjacentHTML("beforeend",o)}let b=1;const T=8;async function S(e,t,o=""){try{const r={limit:e,page:t};o&&(r.category=o);const s=(await f.get(`${D}furnitures`,{params:r})).data;h=s.furnitures,t===1&&(a.furnitureGrid.innerHTML=""),te(h),t*e>=s.totalItems?a.furnitureLoadMoreBtn.style.display="none":a.furnitureLoadMoreBtn.style.display="block"}catch{d.error({title:"Помилка",message:"Не вдалося завантажити дані. Спробуйте пізніше",position:"topRight"})}}function te(e){const t=e.map(({_id:o,name:r,images:n,color:s,price:i})=>{const c=` <ul class="color-list"> 
